	...
	<?php /* 登录了 */ if ($this->user->hasLogin()): ?>
        <div class="aside aside-user">
            <div class="user">
                ...
                <a href="<?php echo getUserPermalink($this->user->uid); ?>"><?php $this->user->screenName(); ?><?php dengji($this->user->mail);?></a>
				<!--访问量-->				
        ...
        <div class="aside aside-user">
            <div class="user">
                ...
                <a href="<?php echo getUserPermalink($this->author->uid); ?>"><?php $this->author->screenName(); ?><?php dengji($this->author->mail);?></a>                
				<!--访问量-->				
                    ...
                    <?php while ($comments->next()) : ?>
                        <li>
                            <div class="user">
                                ...
                                <div class="info">
                                    <div class="name"><?php $comments->author(false); ?><?php dengji($comments->mail);?>	</div>							

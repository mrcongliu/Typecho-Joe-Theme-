...
<body>
    ...
    <div id="navgation" class="navgation navgation_close">
        <ul class="point">
            <li><a href="#">首页</a></li>
            <li><a href="http://liucong.com">博客</a></li>
        ...
        <div class="fp-tablecell">
            <div class="page1">
                <div class="nav wow zoomIn" data-wow-duration="2s">
                    <h1>老狮的梦</h1>
                    <p>一只游走在广袤无垠的草原老狮！</p>
                    <a class="layui-btn layui-btn-normal" style="margin-top: 20px" href="http://liucong.com">Enter Blog</a>
                </div>
                    ...
                    <div class="layui-row">
                        <div class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp" style="padding: 0 10px">
                            <div class="single-news">
                                <div class="news-head">
                                    <img src="http://liucong.com/usr/uploads/2020/03/2402724754.png">
                                    <a href="http://liucong.com/category/game/" class="link"><i class="fa fa-link"></i></a>
                                </div>
                                <div class="news-content">
                                    <h4>
                                        <a href="http://liucong.com/category/game/">
                                           游戏人生
                                        </a>
                                    </h4>                                    
                                    <p>
                        ...
                        <div class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp" data-wow-delay=".2s" style="padding: 0 10px">
                            <div class="single-news">
                                <div class="news-head">
                                    <img src="http://liucong.com/usr/uploads/2021/03/4096227207.jpg">
                                    <a href="http://liucong.com/category/code/" class="link"><i class="fa fa-link"></i></a>
                                </div>
                                <div class="news-content">
                                    <h4>
                                        <a href="http://liucong.com/category/code/">
                                           网络代码
                                        </a>
                                    </h4>                                   
                                    <p>
                        ...
                        <div class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp" data-wow-delay=".4s" style="padding: 0 10px">
                            <div class="single-news">
                                <div class="news-head">
                                    <img src="http://liucong.com/usr/uploads/2020/11/1087236984.jpg">
                                    <a href="http://liucong.com/category/momisc/" class="link"><i class="fa fa-link"></i></a>
                                </div>
                                <div class="news-content">
                                    <h4>
                                        <a href="http://liucong.com/category/momisc/">
                                            观影听音
                                        </a>                                    </h4>
            ...
            <div class="container">
                <div class="layui-row">
                    <div class="layui-col-xs12 layui-col-sm12 layui-col-md12 text-center">
                        <p><span><img src="http://liucong.com/img/beian.png"><a href="http://www.beian.gov.cn/portal/registerSystemInfo"> 皖34081102000372号</a></span>&nbsp;皖ICP备19022537号</p>
                    </div>
                </div>
            </div>
        </div>  

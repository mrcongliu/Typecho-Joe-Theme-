...
function dengji($i){
    ...
    $rbq=$sl['rbq'];}
    if($rbq<1){
    echo '<span class="dengji">博主</span>';
    }elseif ($rbq<10 && $rbq>0) {
    echo '<span class="dengji">闲逛</span>';
    }elseif ($rbq<20 && $rbq>=10) {
    echo '<span class="dengji">小坐</span>';
    }elseif ($rbq<40 && $rbq>=20) {
    echo '<span class="dengji">常憩</span>';
    }elseif ($rbq<80 && $rbq>=40) {
    echo '<span class="dengji">久住</span>';
    }elseif ($rbq<100 && $rbq>=80) {
    echo '<span class="dengji">永驻</span>';
    }elseif ($rbq>=100) {
    echo '<span class="dengji">成家</span>';
    }
}
        ...
        <script>
            $(function() {
                ...
                $("#wmd-button-row #wmd-fullscreen-button").before(`
                    ...
                    <li class="wmd-button custom" id="j-wmd-video-plyr" title="插入视频（plyr）">
